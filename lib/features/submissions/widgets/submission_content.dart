...
class SubmissionContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final submissionBlockReason = targetEvent?.submissionBlockReason();
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          if (submissionBlockReason != null)
            StatusBanner(message: submissionBlockReason, isError: true),
          const SizedBox(height: AppSizes.paddingMedium),
          FilledButton.icon(
            onPressed: loading || targetTeam == null || submissionClosed
                ? null
                : () async {
                    ...
                    if (targetEvent == null) {
                      onErrorChanged(AppStrings.eventNotLoadedForSubmit);
                      return;
                    }
                    final submissionProvider = context
